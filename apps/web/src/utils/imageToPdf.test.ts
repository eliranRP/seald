...
// A real, minimal 1x1 transparent RGBA PNG. jspdf 4.x parses bytes via
// fast-png which validates CRCs strictly, so the chunks here are
// generated with a known-good zlib-deflate IDAT payload + correct
// CRC32s (computed offline). Don't hand-edit — regenerate via the
// helper in `scripts/gen-tiny-png.cjs` if you need to change colour.
