...
import { GoogleButtonRoot, Spinner } from './GoogleButton.styles';
...
export const GoogleButton = forwardRef<HTMLButtonElement, GoogleButtonProps>((props, ref) => {
  const {
  ...
  return (
    ...
    >
      {busy ? <Spinner data-testid="google-button-spinner" aria-hidden /> : <GoogleG />}
      {label}
    </GoogleButtonRoot>
  );
});
