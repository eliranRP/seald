...
Until the repo secret exists, the Chromatic CI job will fail. Add
`CHROMATIC_PROJECT_TOKEN` (value provided by the Chromatic project owner) at:

https://github.com/eliranRP/seald/settings/secrets/actions/new
